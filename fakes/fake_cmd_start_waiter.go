...
func (fake *FakeCmdStartWaiter) Kill() error {
	fake.killMutex.Lock()
...
func (fake *FakeCmdStartWaiter) KillCallCount() int {
	fake.killMutex.RLock()
	defer fake.killMutex.RUnlock()
	return len(fake.killArgsForCall)
}

func (fake *FakeCmdStartWaiter) KillReturns(result1 error) {
	fake.KillStub = nil
...
func (fake *FakeCmdStartWaiter) KillReturnsOnCall(i int, result1 error) {
	fake.KillStub = nil
