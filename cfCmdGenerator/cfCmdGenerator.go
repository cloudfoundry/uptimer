...
type CfCmdGenerator interface {
	...
	Push(name, path, command string, instances int) cmdStartWaiter.CmdStartWaiter
...
func (c *cfCmdGenerator) Push(name, path, command string, instances int) cmdStartWaiter.CmdStartWaiter {
